...
| Issue # | Title | Status |
|---------|-------|--------|
| #1 | Broken link in Open Source Guide | ✅ Closed |
| #3 | Add category filter dropdown | ✅ Closed |
| #5 | Fix search trailing spaces bug | ✅ Closed |
| #7 | Add resource count display | ✅ Closed |
| #9 | Refactor: Move CSS to external stylesheet | ✅ Closed |
